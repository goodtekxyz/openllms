...
async function main() {
  ...
  await page.evaluate(() => {
    ...
    document.getElementById('status-box').innerHTML =
      ...
      '<dt>free used</dt><dd>true</dd>' +
      '<dt>period end</dt><dd>—</dd>' +
      '<dt>provider</dt><dd>—</dd>' +
      '<dt>limits</dt><dd>acc 1 · routes 1 · keys 1 · rpm 30</dd>' +
    ...
    btn.disabled = true;
    const freeBtn = document.getElementById('btn-free') || document.getElementById('btn-trial');
